export const servicesData = [
  {
    ...
    technologies: ['React', 'Node.js', 'Java', 'Python', '.NET', 'MongoDB', 'PostgreSQL'],
  ...
  },
  {
    ...
    technologies: ['React', 'Vue', 'Angular', 'Next.js', 'Node.js', 'Express', 'Tailwind CSS'],
    process: ['Discovery', 'Design', 'Development', 'Testing', 'Launch', 'Maintenance']
  },
  {
    id: 3,
    ...
    technologies: ['Flutter', 'React Native', 'Swift', 'Kotlin', 'Java', 'Firebase'],
  ...
  },
  {
    ...
    process: ['Research', 'Ideation', 'Design', 'Prototype', 'Test', 'Deliver']
  },
  {
    id: 5,
    ...
    process: ['Assessment', 'Strategy', 'Migration', 'Optimization', 'Management']
  },
  {
    id: 6,
    title: 'DevOps',
    ...
    process: ['Assessment', 'Strategy', 'Implementation', 'Automation', 'Monitoring']
  },
  {
    id: 7,
    ...
    process: ['Research', 'Strategy', 'Execution', 'Optimization', 'Reporting']
  },
  {
    id: 8,
    title: 'SEO',
    ...
    technologies: ['Google Search Console', 'SEMrush', 'Ahrefs', 'Moz', 'Screaming Frog'],
    process: ['Audit', 'Research', 'Strategy', 'Implementation', 'Monitoring']
  },
  {
    id: 9,
    ...
    technologies: ['Firewalls', 'IDS/IPS', 'SIEM', 'Encryption', 'Zero Trust Architecture'],
    process: ['Assessment', 'Strategy', 'Implementation', 'Monitoring', 'Response']
  },
  {
    id: 10,
    title: 'AI Solutions',
    ...
    process: ['Discovery', 'Data preparation', 'Model development', 'Training', 'Deployment']
  },
  {
    id: 11,
    ...
    process: ['Discovery', 'Data prep', 'Modeling', 'Evaluation', 'Deployment']
  },
  {
    id: 12,
    ...
    technologies: ['Power BI', 'Tableau', 'Python', 'SQL', 'Snowflake', 'Looker'],
    process: ['Discovery', 'Data prep', 'Analysis', 'Visualization', 'Insights']
  },
  {
    id: 13,
    title: 'ERP Solutions',
    ...
    technologies: ['SAP', 'Oracle', 'Microsoft Dynamics', 'Odoo', 'NetSuite'],
    process: ['Assessment', 'Strategy', 'Implementation', 'Training', 'Support']
  },
  {
    id: 14,
    title: 'CRM Solutions',
    ...
    technologies: ['Salesforce', 'HubSpot', 'Zoho CRM', 'Microsoft Dynamics', 'Pipedrive'],
    process: ['Discovery', 'Strategy', 'Implementation', 'Training', 'Optimization']
  },
  {
    id: 15,
    ...
    technologies: ['Various tech stacks', 'Project management', 'Agile methodology'],
    process: ['Requirements', 'Sourcing', 'Screening', 'Onboarding', 'Support']
  },
  {
    id: 16,
    ...
    technologies: ['Various tech stacks', 'Agile methodology', 'DevOps'],
    process: ['Discovery', 'Sourcing', 'Team formation', 'Onboarding', 'Delivery']
  },
  {
    id: 17,
    title: 'QA Testing',
    ...
    technologies: ['Selenium', 'JUnit', 'TestNG', 'Postman', 'JMeter', 'Cypress'],
    process: ['Planning', 'Design', 'Execution', 'Reporting', 'Retesting']
  },
  {
    id: 18,
